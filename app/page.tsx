    ...
    <div className="settings-main">
      ...
      <Panel title="Параметры Nmap" meta="Применяются ко всем заданиям">
        <div className="settings-form">
          ...
          <div className="form-row"><div><label htmlFor="flags">Флаги Nmap</label><p>Поддерживаются рабочие опции Nmap и их параметры. Цели, файлы ввода/вывода и пути к NSE-коду управляются Vizor.</p></div><input id="flags" className="settings-input mono-input" value={flags} onChange={event => setFlags(event.target.value)} /></div>
